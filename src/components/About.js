...
const AboutMe = React.forwardRef((props, ref) => {
  return (
    <section
      ref={ref}
      className="min-h-screen bg-gray-50 flex flex-col md:flex-row items-center justify-center gap-12 py-20 px-8"
    >
      <RevealItem delay={0}>
        <div className="relative flex-shrink-0 w-64 h-64">
          ...
          <span className="absolute bottom-10 left-8 bg-sky-300 text-black px-3 py-1 rounded-full text-xs font-semibold shadow">
            Front-End Developer
          </span>
          <span className="absolute top-16 right-10 bg-blue-900 text-white px-3 py-1 rounded-full text-xs font-semibold shadow">
            ITE
          </span>
        </div>
      </RevealItem>
      ...
      <RevealItem delay={200}>
        <div className="flex-1 max-w-xl">
          ...
          <button className="mt-8 flex items-center gap-2 bg-blue-900 text-white px-6 py-3 rounded-full hover:bg-sky-400 transition shadow">
